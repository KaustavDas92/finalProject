...
@section('content')
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2 class="font-weight-bold">Update Image </h2>
            ...
            <div class="x_content">
                ...
                <form id="demo-form2" data-parsley-validate="" enctype="multipart/form-data"
                      ...
                      method="POST" action="{{route('productimage.update',$productImage->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control" name="prodId" required="required">
                                <option value="{{$productImage->product_id}}">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text"  value="{{$productImage->img_title}}" id="img_title" name="img_title"required="required" class="form-control ">
                        </div>
                    </div>

                    <div class="item form-group flex">
                        <label for="price" class="col-form-label col-md-3 col-sm-3 label-align">image</label>
                        <div class="col-md-6 col-sm-6  ">
                            <input id="image" class="form-control" type="file" name="image">
                            <img src="{{asset('images/'.$productImage->image)}}"
                                 alt="Watch Image"
                                 width="80"
                                 height="80"
                                class="mt-2">
