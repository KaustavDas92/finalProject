...
@section('content')
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2 class="font-weight-bold text-xl-center">Products Images</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div id="datatable-responsive_filter" class="dataTables_filter">
                                            <label> Create a new Image for this Product
                                                <form method="GET" action="{{route('productimage.create')}}">
                                                    @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                            ...
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 65px;" aria-label="Last name: activate to sort column ascending">Image Title</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive" rowspan="1" colspan="1" style="width: 65px;" aria-label="Last name: activate to sort column ascending">Image</th>
                                            ...
                                            @foreach($productImages as $productImage)
                                                <tr role="row" class="odd">
                                                    <td tabindex="0" class="sorting_1">{{$productImage->product->name}}</td>
                                                    <td>{{$productImage->img_title}}</td>
                                                    <td>
                                                        <img src="{{asset('images/'.$productImage->image)}}" height="50" width="50" class="px-2 align-items-center">
                                                    </td>
                                                    <td>{{$productImage->status}}</td>
                                                    <td class>
                                                        <a class="btn btn-app"
                                                           href="{{route('productimage.edit',$productImage->id)}}">
                                                            <i class="fa fa-edit"></i>
                                                            Edit
                                                        </a>
                                                        <form method="POST"
                                                              action="{{route('productimage.destroy',$productImage->id)}}">
                                                            @csrf
                                                            @method('DELETE')
