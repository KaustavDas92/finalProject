        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form id="demo-form2" data-parsley-validate=""
                      ...
                      method="POST" action="{{route('contact.update',$contact->id)}}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="location" value="{{$contact->location}}" name="location"required="required" class="form-control ">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="address" value="{{$contact->address}}"name="address"required="required" class="form-control ">
                        </div>
                    </div>
                    <div class="item form-group">
                        <label for="email" class="col-form-label col-md-3 col-sm-3 label-align">Email</label>
                        <div class="col-md-6 col-sm-6 ">
                            <input id="email" class="form-control" value="{{$contact->email}}" type="email" name="email">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input id="phone_number" class="form-control" value="{{$contact->phone_number}}" type="number" name="phone_number">
                        </div>
                    </div>
