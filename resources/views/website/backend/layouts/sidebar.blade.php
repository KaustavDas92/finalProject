<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            <li><a><i class="fa fa-home"></i> Product Details <span class="fa fa-chevron-down"></span> </a>
                <ul class="nav child_menu">
                    <li><a href="{{route('productcategory.index')}}">Brands</a></li>
...
{{--            <li><a href="{{route('product.index')}}"><i class="fa fa-home"></i> Product <!--<span class="fa fa-chevron-down"></span> --></a>--}}
{{--            </li>--}}
