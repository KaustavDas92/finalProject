                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <select class="form-control" name="prodId" required="required" >
                                <option value="{{$product->product_category_id}}">{{$product->product_category->brand_name}}</option>
                                @foreach($productCategory as $brand)
                                    @if($brand->id != $product->product_category_id)
                                    <option  value="{{$brand->id}}" name="prodId">{{$brand->brand_name}}</option>
                                    @endif
                                @endforeach
                            </select>
{{--                            <input type="text" id="productCategory_name"--}}
{{--                                   value="{{$product->product_category->brand_name}}"--}}
{{--                                   name="productCategory_name"required="required" class="form-control ">--}}
                        </div>
                    </div>
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input type="text" id="name"
                                   value="{{$product->name}}" name="name"required="required" class="form-control ">
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            <input id="price" value="{{$product->price}}" class="form-control" type="text" name="price">
                        </div>
                    </div>
